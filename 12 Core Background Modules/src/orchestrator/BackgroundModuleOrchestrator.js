import AbenaSDK from '../../abena_sdk/index.js';
...
export default class BackgroundModuleOrchestrator {
  constructor(patientData, abenaLogger = {}) {
    // First, create full SDK with logger
    const abenaSDK = new AbenaSDK({
      ...
      logError: abenaLogger.logError || ((msg) => console.error("[LogError Fallback]", msg)),
      logActivity: abenaLogger.logActivity || ((msg) => console.log("[LogActivity Fallback]", msg)),
      ...abenaLogger
    });

    // Pass the same SDK object to all modules
    this.modules = {
      metabolome: new MetabolomeBackgroundModule(abenaSDK),
      microbiome: new MicrobiomeBackgroundModule(abenaSDK),
      inflammatome: new InflammatomeBackgroundModule(abenaSDK),
      immunome: new ImmunomeBackgroundModule(abenaSDK),
      chronobiome: new ChronobiomeBackgroundModule(abenaSDK),
      nutriome: new NutriomeBackgroundModule(abenaSDK),
      toxicome: new ToxicomeBackgroundModule(abenaSDK),
      pharmacome: new PharmacomedBackgroundModule(abenaSDK),
      stressResponse: new StressResponseBackgroundModule(abenaSDK),
      cardiovascular: new CardiovascularBackgroundModule(abenaSDK),
      neurological: new NeurologicalBackgroundModule(abenaSDK),
      hormonal: new HormonalBackgroundModule(abenaSDK)
    };
