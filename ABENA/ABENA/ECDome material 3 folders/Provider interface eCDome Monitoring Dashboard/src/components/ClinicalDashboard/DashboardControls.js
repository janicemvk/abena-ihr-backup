    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900 flex items-center">
          <Settings className="h-5 w-5 mr-2 text-ecdome-primary" />
          Dashboard Controls
        </h3>
        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-ecdome-primary focus:border-transparent"
            >
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="px-3 py-1 text-sm bg-ecdome-primary text-white rounded hover:bg-blue-700">
              Apply
            </button>
          </div>
        </div>
