...
/// Minimum period of blocks on which justifications are imported and generated.
...
/// Builds a full node. `N` must match [`Configuration::network`]'s backend (see `command.rs`).
pub fn new_full<
