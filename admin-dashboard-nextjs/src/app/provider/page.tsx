...
const features = [
  ...
  },
  {
    ...
    description: 'Communicate with patients securely',
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            <UserCircleIcon className="h-8 w-8 text-ecbome-primary" />
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">Provider Portal</h1>
          </div>
