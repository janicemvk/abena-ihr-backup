const API_CONFIG = {
  ...
  BASE_URLS: {
    IHR_INTELLIGENCE: process.env.REACT_APP_IHR_INTELLIGENCE_URL || 'http://localhost:8080/api/v1/background-modules',
    MEDICAL_DB: process.env.REACT_APP_MEDICAL_DB_URL || 'http://localhost:8080/api/v1/background-modules',
    DRUG_INTERACTIONS: process.env.REACT_APP_DRUG_INTERACTIONS_URL || 'http://localhost:8080/api/v1/background-modules',
    SCIENTIFIC_LIT: process.env.REACT_APP_SCIENTIFIC_LIT_URL || 'http://localhost:8080/api/v1/background-modules',
    LAB_RESULTS: process.env.REACT_APP_LAB_RESULTS_URL || 'http://localhost:8080/api/v1/background-modules'
  },
